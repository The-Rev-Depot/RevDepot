...
INSERT INTO user (username, password, first_name, last_name, email, url_pro_pic, birthday) 
VALUES ('User1', '12345', 'user', 'lastname', 'email@email.com', 'https://i.pinimg.com/originals/f4/cd/b0/f4cdb0f288f3f46186a2366cb3fb9b31.jpg'
, '1990-12-24');

INSERT INTO user (username, password, first_name, last_name, email, url_pro_pic, birthday) 
VALUES ('User2', '123456', 'user2', 'lastname2', 'email2@email.com', 'https://thehill.com/sites/default/files/ca_stevecarell_052920getty.jpg'
, '1990-11-02');
...
INSERT INTO product (product_name, product_description, pic_url, product_price, product_rating, product_category, sale_id) VALUES ('Notebook', 'Hard cover notebook. Black outside, orange inside.'
, 'https://commonmedia.asicentral.com/5560000/5563465/revature_set.png'
, 8.99, 2.9, 'Office Supplies', 0);

INSERT INTO product (product_name, product_description, pic_url, product_price, product_rating, product_category, sale_id) VALUES ('Sticker', 'I love pie sticker'
...
iNSERT INTO inventory (quantity, product_id) VALUES (20, 1);

INSERT INTO inventory (quantity, product_id) VALUES (30, 2);

INSERT INTO inventory (quantity, product_id) VALUES (50, 3);

INSERT INTO inventory (quantity, product_id) VALUES (10, 4);
